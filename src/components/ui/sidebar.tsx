      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-card/80 backdrop-blur-lg p-0 text-card-foreground [&>button]:hidden"
            style={
              {
        ...
        >
          <div
            ...
            className={cn(
                ...
                variant === "floating" ? "bg-card/80 backdrop-blur-lg rounded-lg border shadow-lg" : "bg-card"
            )}
          >
            {children}
          </div>
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-muted-foreground/80 outline-none ring-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
